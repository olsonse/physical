...
_OPEN_NAMESPACE(constant_si,physical) {
    _OPEN_NAMESPACE(constant_si,constant) {
      _BEGIN_NAMESPACE(si) {
        ...
        _QUANTITYn(h,                 6.62606896e-34*J*s,          "Planck constant");
        _QUANTITYn(h_bar,             h/(2.0*pi*unit::rad),        "Planck constant");
        _QUANTITY(g,                  unit::gravity);
        _QUANTITYn(e,                 1.602176487e-19*C,           "electron charge");
        ...
        _QUANTITYn(Rinfinity,         10973731.568527/m,           "Rydberg constant (R_inf)");
        ...
        _QUANTITYn(m_e,               9.10938215e-31*kg,           "electron mass");
        _QUANTITYn(m_p,               1.672621637e-27*kg,          "proton mass");
        _QUANTITYn(m_d,               1875.612793*MeV/(c*c),       "deuteron mass");
        _QUANTITYn(atomic_mass_unit,  1.660538782e-27*kg,          "unified atomic mass unit");
        ...
        _QUANTITYn(epsilon0,          8.854187817e-12*F/m,         "permittivity of free space");
        _QUANTITYn(k_E,               1./(4*pi*epsilon0),          "Coulomb constant");
        _QUANTITYn(mu0,               4*pi*1e-7*N/(A*A),           "permeability of free space");
        ...
        _QUANTITYn(sigma_0,           0.6652458558*barns,          "Thomson cross section");
        _QUANTITYn(mu_B,              5.7883818e-11*MeV/T,         "Bohr magneton");
        _QUANTITYn(mu_N,              3.1524513e-14*MeV/T,         "nuclear magneton");
        _QUANTITYn(e_m_e,             e / m_e,                     "electron cyclotron frequency/field");
        _QUANTITYn(e_m_p,             e / m_p,                     "proton cyclotron frequency/field");
        _QUANTITYn(G,                 6.67428e-11*m*m*m/(kg*s*s),  "gravitational constant");
        _QUANTITYun(N_A,              6.02214179e23, units_map(),  "Avogadro's constant");
        _QUANTITYn(K_B,               1.3806504e-23*J/K,           "Boltzmann constant");
        _QUANTITYn(stdtemp,           273.15 * K,                  "standard temperature");
        _QUANTITYn(R,                 K_B * N_A,                   "universal gas constant");
        _QUANTITYn(V_molar,           unit::mol*R*stdtemp/unit::atm,"molar volume, ideal gas at standard temperature and pressure");
        _QUANTITYn(sigma_SB,          5.670400e-8*W/(m*m*K*K*K*K), "Stefan-Boltzmann constant");
      _END_NAMESPACE}
