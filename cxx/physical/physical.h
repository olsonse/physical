...
#  define PHYSICAL_QUANTITY_INIT(name,c)       (c,"",#name)
#  define PHYSICAL_QUANTITY_INITu(name,c,u)    (c,u,"",#name)
#  define PHYSICAL_QUANTITY_INITn(name,c,n)    (c,n,#name)
#  define PHYSICAL_QUANTITY_INITun(name,c,u,n) (c,u,n,#name)
