...
#ifndef physical_calc_detail_Driver_h
#define physical_calc_detail_Driver_h
  ...
  namespace calc {
    namespace detail {
      ...
      public:
        ...
        Driver( class expression::Context & calc );
...
#endif // physical_calc_detail_Driver_h
