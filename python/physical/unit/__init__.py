...
from . import admiralty
from . import apothecary
from . import ap              # dummy module for apothecary
from . import troy            # dummy module for apothecary
from . import t               # dummy module for apothecary
from . import arc
from . import avoirdupois
from . import avdp            # dummy module for avoirdupois
from . import av              # dummy module for avoirdupois
from . import bakers
from . import British
from . import English         # dummy module for British
from . import Imperial        # dummy module for British
...
from . import Hefner
from . import metric
from . import nautical
from . import marine          # dummy module for nautical
from . import statute
from . import US
